...
export class TopicsService {
  ...
  async create(createTopicDto: CreateTopicDto, token: string) {
    ...
    let info_user = await this.findUser('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiaWF0IjoxNjY0MzI0NDAzLCJleHAiOjE2NjQ5MjkyMDN9.KAe_Ocnzu377HeX2PJOR9J5uYxC-RtxMEuI3bnu8mx8').then((res) => {
